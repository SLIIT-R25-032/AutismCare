...
Using machine learning, image processing, and adaptive learning systems, the app provides a structured environment for skill development in areas such as pattern recognition, shape identification, number writing, memory, and problem-solving. It further includes relaxation sessions to support emotional regulation and sensory balance, promoting a positive learning experience at home.
...
o	✅ Shape and number recognition
o	✅ Counting and quantity understanding
...
•	Real-time tracking: task completion %, error rates, time
...
•	▶️ Tap an activity from Home Page
•	🧠 Let the child complete interactive tasks
•	📈 Track progress & access personalized reports
